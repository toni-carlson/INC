...
export const ailmentsInfo = [
    ...
    },
    {
      icon: faLightbulb,
      heading: 'Memory',
      subheading: 'Do you struggle with symptoms of memory loss?',
      content: `If you are beginning to notice the signs of brain fog, forgetfulness, declining cognitive function,
        ...
        are often associated with the inability to process information optimally. If left untreated, this can lead to
        dementia.`
    },
    {
      icon: faHammer,
